...
<template>
    ...
    >
        <!--begin::Brand-->
        <!-- <div class="aside-logo flex-column-auto mx-auto mb-14" id="kt_aside_logo">
			<Link :href="route('dashboard')">
				<img alt="Logo" src="assets/media/logos/Logo.png" class="h-[125px] logo theme-light-show" />
				<img alt="Logo" src="assets/media/logos/Logo.png" class="h-[125px] logo theme-dark-show" />
			</Link>
		</div> -->
        <!--end::Brand-->
        <!--begin::Aside user-->
                            ...
                            >
                                ...
                                <div class="menu-item px-3">
                                    <a
                                        ...
                                        >
                                            <i
                                                class="ki-duotone ki-information-5 fs-5"
                                            >
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                                <span class="path3"></span>
