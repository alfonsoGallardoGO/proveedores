...
<template>
    <div id="kt_aside" class="aside pt-7 pb-4 pb-lg-7 pt-lg-17 aside-dark shadow" data-kt-drawer="true"
        ...
        <div class="aside-user mb-5 mb-lg-10" id="kt_aside_user">
            ...
            <div class="d-flex align-items-center flex-column">
                ...
                <div class="symbol symbol-75px mb-4">
                    <img :src="$page.props.auth.user?.profile_photo_url" alt="" class="object-cover" />
                </div>
                <!--end::Symbol-->
                <!--begin::Info-->
                <div class="text-center mb-10">
                    <!--begin::Username-->
                    <Link href="/user/profile" class="hover:text-[#ed6d24] fs-4 fw-bolder">{{
        ...
        <div class="aside-footer flex-column-auto px-6 px-lg-9" id="kt_aside_footer">
            ...
            <div class="d-flex flex-stack ms-7">
                ...
                <a @click.prevent="logout" href="#"
                    ...
                    <!--begin::Major-->
                    <span class="d-flex flex-shrink-0 fw-bold fs-7">Cerrar Sesión</span>
                    <!--end::Major-->
                </a>
                <!--end::Link-->
                <!--begin::User menu-->
                <div class="ms-1">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" :src="$page.props.auth.user
                                            ?.profile_photo_url
                                        " />
                                </div>
                                <!--end::Avatar-->
                        ...
                        <div class="menu-item px-5">
                            <Link class="menu-link px-5" href="user/profile">Perfil</Link>
                        </div>
                        <!--end::Menu item-->

                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="authentication/layouts/corporate/sign-in.html" class="menu-link px-5">Cerrar
                                Sesión</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
